...
import video_home from "./assets/homeThumb.mp4";
import music_Earthquake from "./assets/homeMusic.mp3";
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // let homeVideo = document.querySelector("section.home video");
    ...
    function videoTimeline() {
        var Tween_video = new TimelineMax();
        Tween_video.to(
            homeVideo,
            0.4, {
                scale: 0.2,
    ...
    }).add(navIconTimeline()).add(dotIconsTimeline());
    ...
    //Initialize Home Page Animation at Start
